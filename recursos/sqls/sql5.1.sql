-- version 2, mejorada, tomando como modelo el sql del curso
-- by sanchezluys 2024
-- todo se coloca en minusculas para evitar errores
-- se define el nombre de la bd a usar
use credicel_alura_bd;

-- se borran las tablas tbcliente y tbproducto si existen
DROP TABLE IF EXISTS credicel_alura_bd.tbcliente;
DROP TABLE IF EXISTS credicel_alura_bd.tbproducto;
DROP TABLE IF EXISTS credicel_alura_bd.tbvendedor;


-- se crea la tabla tbcliente
...
-- se agrega la llave primaria a la tabla tbcliente
ALTER TABLE tbcliente ADD PRIMARY KEY (DNI);

-- se cre la tabla tbproducto
...
-- se le agrega la llave primaria a la tabla tbproducto
ALTER TABLE tbproducto ADD PRIMARY KEY (PRODUCTO);

-- se agregan datos a la tabla tbcliente
...
-- se agregan datos a la tabla tbproducto
...
CREATE TABLE `credicel_alura_bd`.`vendedores` (
